...
sender_mnemonic_input = "Sender Private Mnemonic Here"
recipient_address = "Recipient Wallet Address here"
recipient_mnemonic_input = "Recipient Private Mnemonic here"

# Convert Mnemonic to Private Key
sender_mnemonic = re.sub(",", "", sender_mnemonic_input)
recipient_mnemonic = re.sub(",", "", recipient_mnemonic_input)
...
def close_out_asset(asset_id, sender_address, recipient_address, sender_private_key):
...
for asset in sender_account_info["assets"]:
    ...
    #     close_out_asset(asset_id, sender_address, recipient_address, sender_private_key)
